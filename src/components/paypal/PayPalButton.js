    ...
    render() {
        ...
        const onSuccess = (payment, addedItems = this.addedItems) => {
            // Congratulation, it came here means everything's fine!
                    ...
                    const paymentData = [addedItems, addressWithId]
            		// You can bind the "payment" object's value to your state or props or whatever here, please see below for sample returned data
                    this.props.dispatch(addCustomer(paymentData));
                    
                    
                    this.props.history.push('/customer/'+addressWithId.id)
                }
...
export default withRouter(connect(mapDispatchToProps)(MyApp))